        ...
        if (block === "{{ITCH_BUTTON}}" && project.itchUrl) {
          return (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-3 text-sm font-medium text-primary-foreground transition-colors hover:brightness-95"
            >
              <span>{project.itchLabel ?? "Open on itch.io"}</span>
        ...
        >
          ...
          <div className="px-8 pb-[10%] pt-8 md:px-[12%] md:pt-10 md:pb-[10%] lg:px-[20%]">
            <button
              type="button"
              onClick={onClose}
              className="mb-8 inline-flex items-center gap-2 text-foreground transition-colors hover:text-primary"
            >
              <ArrowLeft className="h-4 w-4" />
              <span>Back to projects</span>
            </button>
        ...
        >
          ...
          <div className="flex items-center justify-between gap-4 border-b border-border px-6 py-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="mb-1 text-xl">Resume / CV</h3>
                <p className="text-sm text-muted-foreground">Nguyen Duc Son Hai_CV.pdf</p>
              </div>
            </div>
